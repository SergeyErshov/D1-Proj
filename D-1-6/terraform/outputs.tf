...
output "internal_ipaddr_vm04" {
  description = "internal ip 0f VM"
  value       = module.yandex_instance_4.internal_ipaddr_vm
}

output "external_ipaddr_vm04" {
  description = "external ip of VM"
  value       = module.yandex_instance_4.external_ipaddr_vm
}
